  ...
  inventorySubmenuItems.forEach((item) => {
    ...
    button.addEventListener('click', (event) => {
      ...
      /*
        ...
        AsÃ­ evitamos la pantalla en blanco.
        Luego conectamos uno por uno: Productos, Almacenes, RecepciÃ³n, etc.
      */
    })
  ...
  useEffect(() => {
    ...
    const enterModuleModeDelayed = () => {
      ...
      /*
        ...
        Primero dejamos que React abra el mÃ³dulo.
        Luego activamos modo pÃ¡gina.
      */
      window.setTimeout(() => {
