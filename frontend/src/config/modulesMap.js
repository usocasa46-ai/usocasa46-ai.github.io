...
export const erpModules = [
  ...
  },
  {
    ...
    pages: [
      ...
      { id: 'accounting-electronic-billing', label: 'Facturacion Electronica e-CF', keywords: ['ecf', 'facturacion electronica', 'dgii', 'xml'] },
  ...
  },
  {
    ...
    icon: 'UsersRound',
    pages: [
      { id: 'hr-dashboard', label: 'Panel RRHH' },
      { id: 'hr-employees', label: 'Empleados' },
      { id: 'hr-departments', label: 'Departamentos' },
      { id: 'hr-positions', label: 'Puestos' },
      { id: 'hr-contracts', label: 'Contratos' },
      { id: 'hr-attendance', label: 'Asistencia' },
      { id: 'hr-absences', label: 'Permisos y ausencias' },
      { id: 'hr-vacations', label: 'Vacaciones' },
      { id: 'hr-overtime', label: 'Horas extras' },
      { id: 'hr-payroll', label: 'Nomina' },
      { id: 'hr-pay-slips', label: 'Volantes de pago' },
      { id: 'hr-payroll-settings', label: 'Configuracion de nomina' },
